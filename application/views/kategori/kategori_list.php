...
<div class="container">
    <div class="row">
        ...
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('kategori/create'),'Create', 'class="btn btn-primary base-background white"'); ?>
            </div>
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('kategori'); ?>" class="btn btn-default base-background white">Reset</a>
                                    <?php
                                }
                            ?>
		...
		<?php echo anchor(site_url('kategori/excel'), 'Excel', 'class="btn btn-primary base-background white"'); ?>
	    </div>
